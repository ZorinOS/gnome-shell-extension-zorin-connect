...
var DevicePreferences = GObject.registerClass({
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/ZorinConnect/ui/device-preferences.ui',
    Children: [
    ...
    get menu() {
        if (this._menu === undefined) {
            let menus = Gtk.Builder.new_from_resource(
                '/org/gnome/Shell/Extensions/ZorinConnect/gtk/menus.ui'
            );
            menus.translation_domain = 'org.gnome.Shell.Extensions.ZorinConnect';
