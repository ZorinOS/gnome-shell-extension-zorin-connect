...
var ConnectDialog = GObject.registerClass({
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/ZorinConnect/ui/connect.ui',
    Children: [
...
var Window = GObject.registerClass({
    ...
    _restoreGeometry() {
        this._windowState = new Gio.Settings({
            settings_schema: zorin_connect.gschema.lookup(
                'org.gnome.Shell.Extensions.ZorinConnect.WindowState',
                true
            ),
    ...
    _aboutDialog() {
        if (this._about === undefined) {
            this._about = new Gtk.AboutDialog({
                ...
                version: zorin_connect.metadata.version.toString(),
