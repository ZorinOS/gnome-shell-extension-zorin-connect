...
class ServiceIndicator extends PanelMenu.SystemIndicator {
    ...
    constructor() {
        ...
        // Watch for UI prefs
        this._gsettingsId = zorin_connect.settings.connect(
    ...
    _sync() {
        ...
        let panelMode = zorin_connect.settings.get_boolean('show-indicators');
    ...
    destroy() {
        ...
        zorin_connect.settings.disconnect(this._gsettingsId);
...
function init() {
    ...
    // Since they *only* affect notifications from Zorin Connect, it should be okay
