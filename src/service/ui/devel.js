...
function getPID() {
    return Gio.DBus.session.call_sync(
        ...
        new GLib.Variant('(s)', ['org.gnome.Shell.Extensions.ZorinConnect']),
        null,
...
var Window = GObject.registerClass({
    GTypeName: 'ZorinConnectDevelWindow',
    Template: 'resource:///org/gnome/Shell/Extensions/ZorinConnect/devel.ui',
    Children: [
    ...
    _init() {
        ...
        this.add_action(zorin_connect.settings.create_action('debug'));
    ...
    _openLog() {
        try {
            ...
            Gio.AppInfo.create_from_commandline(
                'journalctl -f -o cat GLIB_DOMAIN=ZorinConnect',
                'ZorinConnect',
