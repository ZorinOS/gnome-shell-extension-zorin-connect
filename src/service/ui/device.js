...
const SectionRow = GObject.registerClass({
    GTypeName: 'ZorinConnectSectionRow'
...
var DevicePreferences = GObject.registerClass({
    GTypeName: 'ZorinConnectDevicePreferences',
    Template: 'resource:///org/gnome/Shell/Extensions/ZorinConnect/device.ui',
    Children: [
    ...
    _init(device) {
        ...
        // Menus
        this._menus = Gtk.Builder.new_from_resource(zorin_connect.app_path + '/gtk/menus.ui');
        this._menus.translation_domain = 'org.gnome.Shell.Extensions.ZorinConnect';

        // GSettings
        this.settings = new Gio.Settings({
            settings_schema: zorin_connect.gschema.lookup('org.gnome.Shell.Extensions.ZorinConnect.Device', true),
            path: '/org/gnome/shell/extensions/zorin-connect/device/' + this.device.id + '/'
        });
    ...
    _getSettings(name) {
        ...
        this._gsettings[name] = new Gio.Settings({
            settings_schema: zorin_connect.gschema.lookup(meta.id, -1),
    ...
    _queryApplications(settings) {
        ...
        let appInfos = [];
        let ignoreId = 'org.gnome.Shell.Extensions.ZorinConnect.desktop';
