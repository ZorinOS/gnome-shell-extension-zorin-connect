...
const MediaPlayer2Proxy = DBus.makeInterfaceProxy(
    zorin_connect.dbusinfo.lookup_interface('org.mpris.MediaPlayer2')
);
...
const PlayerProxy = DBus.makeInterfaceProxy(
    zorin_connect.dbusinfo.lookup_interface('org.mpris.MediaPlayer2.Player')
);
