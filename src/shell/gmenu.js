        ...
        switch (name) {
            case 'icon':
                ...
                if (value instanceof Gio.ThemedIcon)
                    value = zorin_connect.get_gicon(value.names[0]);
...
var ListBox = class ListBox extends PopupMenu.PopupMenuSection {
    ...
    constructor(params) {
        ...
        this.box.add_style_class_name('zorin-connect-list-box');
...
var IconButton = GObject.registerClass({
    GTypeName: 'ZorinConnectShellIconButton'
}, class Button extends St.Button {

    _init(params) {
        super._init({
            style_class: 'system-menu-action zorin-connect-icon-button',
            can_focus: true
        });
        Object.assign(this, params);
...
var IconBox = class IconBox extends PopupMenu.PopupMenuSection {
    ...
    constructor(params) {
        ...
        this.box.style_class = 'zorin-connect-icon-box';
