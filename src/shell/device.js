...
var Battery = GObject.registerClass({
    GTypeName: 'ZorinConnectShellDeviceBattery',
}, class Battery extends St.BoxLayout {

    _init(params) {
        super._init({
            reactive: true,
            style_class: 'zorin-connect-device-battery',
            track_hover: true,
        });
...
var SignalStrength = GObject.registerClass({
    GTypeName: 'ZorinConnectShellDeviceSignalStrength',
}, class SignalStrength extends St.BoxLayout {

    _init(params) {
        super._init({
            reactive: true,
            style_class: 'zorin-connect-device-signal-strength',
            track_hover: true,
        });
        Object.assign(this, params);
...
var Indicator = GObject.registerClass({
    GTypeName: 'ZorinConnectDeviceIndicator',
