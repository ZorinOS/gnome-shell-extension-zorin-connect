...
if (GLib.getenv('ZORIN_CONNECT_TEST')) {
 ...
 *
 * @returns {string} A Zorin Connect device type
 */
...
/**
 * Create temporary directories used by Zorin Connect.
 *
 * @returns {string} The root temporary directory
 */
function isolateDirectories() {
    const tmpdir = GLib.Dir.make_tmp('zorin-connect.XXXXXX');
...
/**
 * A test rig with two active ZorinConnectChannelService instances.
 */
