...
const MSGID = {
    'Zorin Connect': 'extensionName',
    'Share links with Zorin Connect, direct to the browser or by SMS.': 'extensionDescription',
...
_('Share links with Zorin Connect, direct to the browser or by SMS.');
// TRANSLATORS: Top-level context menu item for Zorin Connect
_('Send To Mobile Device');
// TRANSLATORS: WebExtension can't connect to Zorin Connect
